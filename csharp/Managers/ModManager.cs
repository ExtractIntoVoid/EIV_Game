...
namespace ExtractIntoVoid.Managers
{
    internal partial class ModManager : Node
    {
        ...
        public void LoadAllMods()
        {
            ...
            MainLoader.AddSharedAssembly(typeof(JsonConvert).Assembly);
            MainLoader.AddSharedAssembly(typeof(SemanticVersioning.Version).Assembly);
        ...
        void LoadMod(string modDir)
        {
            ...
            MainLoader.LoadPlugin(modData.AssemblyName);
            ProjectSettings.LoadResourcePack(modData.ResourcePack);
